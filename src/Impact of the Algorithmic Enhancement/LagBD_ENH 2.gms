...
file LagBD /LagBD.dat/;
put LagBD;
LagBD.ap = 1;

put  %ID%, " ", LagTime, " ", LagLB, " ", LagUB, " ", subprobtime, " ", mastersoltime, " ", totaltime, " ", Bendcutnum, " ", totalopenhubs, " ", totalhubcost, " ", totalIassCost, " ", totalDassCost, " ", totaltransportcost, " ", LB, " ", UB  ///
