...
master_obj_uncap..  MasterCost =e= zetavar + sum((hubs), HubCost(hubs)*z(hubs))+ sum((origins, products)$ProdOriginsset(products, origins), ocCost(origins, products)*y(origins, products))
                                 + sum((destinations, products)$ProdDestinationsset(products, destinations), dcCost(destinations, products)*u(destinations, products)) ;
...
parameter initstate;
initstate = 0;
parameter mastersoltime, uncaptime, subprobtime, Bendcutnum;
mastersoltime = 0;
uncaptime = 0;
subprobtime = 0;
Bendcutnum = 0;
...
file LagBD_IC /LagBD_IC.dat/;
put LagBD_IC;
LagBD_IC.ap = 1;

put  %ID%, " ", LagTime, " ", LagLB, " ", LagUB, " ", subprobtime, " ", mastersoltime, " ", uncaptime, " ", totaltime, " ", Bendcutnum, " ", totalopenhubs, " ", totalhubcost, " ", totalIassCost, " ", totalDassCost, " ", totaltransportcost, " ", LB, " ", UB  ///
