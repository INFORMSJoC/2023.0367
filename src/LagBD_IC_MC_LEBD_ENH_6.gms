...
removedhubs(hubs) = no;
set removedhubs2(hubs);
removedhubs2(hubs) = no;


parameter MLstagetime;
if(HubCostcoef eq 10,
       MLstagetime = maxtime/20;
       else
       MLstagetime = maxtime/2;
   );
...
master_obj..  MasterCost =e= sum((k), zetavar(k)) + sum((hubs)$((not removedhubs(hubs)) and (not removedhubs2(hubs))), HubCost(hubs)*z(hubs))
                                 + sum((origins, products)$ProdOriginsset(products, origins), ocCost(origins, products)*y(origins, products))
                                 + sum((destinations, products)$ProdDestinationsset(products, destinations), dcCost(destinations, products)*u(destinations, products)) ;

cut(cutset, k)..
              zetavar(k) =g= sum(products$(product_k_final(products, k)), cutconst1(cutset, products))
                                 - sum((hubs, products)$(product_k_final(products, k) and ((not removedhubs(hubs)) and (not removedhubs2(hubs)))), z(hubs)*cutcoeff1(cutset, hubs, products))
...
HubOpenMstr..
         sum(hubs$((not removedhubs(hubs)) and (not removedhubs2(hubs))), z(hubs)) =g= 1 ;
...
parameter removesizefromQ;
parameter getQhubsize;
parameter getremovedsize;
...
parameter testdone2;
testdone2 = 0;
parameter removedhubnum2, remove2check;
removedhubnum2 = 0;
remove2check = 0;
parameter rankhubprobability(hubs);

parameter constcoeff07(iter), constcoeff10(iter), constcoeff11(iter);
constcoeff07('iter1') = -7.0824; constcoeff07('iter2') = -7.3097; constcoeff07('iter3') = -7.0824; constcoeff07('iter4') = -7.0824; constcoeff07('iter5') = -7.0824; constcoeff07('iter6') = -7.1854; constcoeff07('iter7') = -7.0824; constcoeff07('iter8') = -7.5413; constcoeff07('iter9') = -7.7374; constcoeff07(iter)$(ord(iter) ge 10) = -6.6816;
constcoeff10('iter1') = -7.4546; constcoeff10('iter2') = -8.1417; constcoeff10('iter3') = -7.7622; constcoeff10('iter4') = -7.4595; constcoeff10('iter5') = -7.6776; constcoeff10('iter6') = -7.2648; constcoeff10('iter7') = -8.0672; constcoeff10('iter8') = -6.3141; constcoeff10('iter9') = -10.1574; constcoeff10(iter)$(ord(iter) ge 10) = -8.6954;
constcoeff11('iter1') = -6.538; constcoeff11('iter2') = -6.0942; constcoeff11('iter3') = -6.0942; constcoeff11('iter4') = -6.0942; constcoeff11('iter5') = -6.6487; constcoeff11('iter6') = -6.0464; constcoeff11('iter7') = -6.6005; constcoeff11('iter8') = -6.6964; constcoeff11('iter9') = -6.9928; constcoeff11(iter)$(ord(iter) ge 10) = -9.1325;

parameter LPcoeff07(iter), LPcoeff10(iter), LPcoeff11(iter);
LPcoeff07('iter1') = 10.6228; LPcoeff07('iter2') = 9.4916; LPcoeff07('iter3') = 10.6228; LPcoeff07('iter4') = 10.6228; LPcoeff07('iter5') = 10.6228; LPcoeff07('iter6') = 10.5391; LPcoeff07('iter7') = 10.6228; LPcoeff07('iter8') = 10.9388; LPcoeff07('iter9') = 10.539; LPcoeff07(iter)$(ord(iter) ge 10) = 9.9886;
LPcoeff10('iter1') = 6.2245; LPcoeff10('iter2') = 6.8935; LPcoeff10('iter3') = 6.3568; LPcoeff10('iter4') = 6.1691; LPcoeff10('iter5') = 5.8551; LPcoeff10('iter6') = 5.5525; LPcoeff10('iter7') = 4.7907; LPcoeff10('iter8') = 4.2821; LPcoeff10('iter9') = 4.0679; LPcoeff10(iter)$(ord(iter) ge 10) = 4.7266;
LPcoeff11('iter1') = 15.2994; LPcoeff11('iter2') = 13.9146; LPcoeff11('iter3') = 13.9146; LPcoeff11('iter4') = 13.9146; LPcoeff11('iter5') = 14.6113; LPcoeff11('iter6') = 13.0933; LPcoeff11('iter7') = 13.679; LPcoeff11('iter8') = 11.5187; LPcoeff11('iter9') = 11.7846; LPcoeff11(iter)$(ord(iter) ge 10) = 14.9571;

parameter Lagcoeff07(iter), Lagcoeff10(iter), Lagcoeff11(iter);
Lagcoeff07('iter1') = 4.1788; Lagcoeff07('iter2') = 4.2571; Lagcoeff07('iter3') = 4.1788; Lagcoeff07('iter4') = 4.1788; Lagcoeff07('iter5') = 4.1788; Lagcoeff07('iter6') = 4.1447; Lagcoeff07('iter7') = 4.1788; Lagcoeff07('iter8') = 4.248; Lagcoeff07('iter9') = 4.5721; Lagcoeff07(iter)$(ord(iter) ge 10) = 3.4329;
Lagcoeff10('iter1') = 5.5217; Lagcoeff10('iter2') = 5.5276; Lagcoeff10('iter3') = 5.4014; Lagcoeff10('iter4') = 5.2693; Lagcoeff10('iter5') = 4.9018; Lagcoeff10('iter6') = 4.4418; Lagcoeff10('iter7') = 5.5669; Lagcoeff10('iter8') = 4.0722; Lagcoeff10('iter9') = 6.7732; Lagcoeff10(iter)$(ord(iter) ge 10) = 4.8817;
Lagcoeff11(iter) = 0;

parameter BDSolcoeff07(iter), BDSolcoeff10(iter), BDSolcoeff11(iter);
BDSolcoeff07(iter)$(ord(iter) le 5) = 0; BDSolcoeff07('iter6') = 0.4132; BDSolcoeff07('iter7') = 0; BDSolcoeff07('iter8') = 0.4599; BDSolcoeff07('iter9') = 0.4298; BDSolcoeff07(iter)$(ord(iter) ge 10) = 0.9141;
BDSolcoeff10('iter1') = 0; BDSolcoeff10('iter2') = 1.1078; BDSolcoeff10('iter3') = 0.7013; BDSolcoeff10('iter4') = 0.5972; BDSolcoeff10('iter5') = 1.3805; BDSolcoeff10('iter6') = 1.5167; BDSolcoeff10('iter7') = 2.2685; BDSolcoeff10('iter8') = 2.464; BDSolcoeff10('iter9') = 4.1355; BDSolcoeff10(iter)$(ord(iter) ge 10) = 3.9579;
BDSolcoeff11('iter1') = 0; BDSolcoeff11('iter2') = 0; BDSolcoeff11('iter3') = 0; BDSolcoeff11('iter4') = 0; BDSolcoeff11('iter5') = 0.9176; BDSolcoeff11('iter6') = 1.1733; BDSolcoeff11('iter7') = 2.0831; BDSolcoeff11('iter8') = 2.0567; BDSolcoeff11('iter9') = 2.3027; BDSolcoeff11(iter)$(ord(iter) ge 10) = 5.741;

parameter CRankcoeff07(iter), CRankcoeff10(iter), CRankcoeff11(iter);
CRankcoeff07('iter1') = -4.843; CRankcoeff07('iter2') = -5.3312; CRankcoeff07('iter3') = -4.843; CRankcoeff07('iter4') = -4.843; CRankcoeff07('iter5') = -4.843; CRankcoeff07('iter6') = -4.7186; CRankcoeff07('iter7') = -4.843; CRankcoeff07('iter8') = -4.2913; CRankcoeff07('iter9') = -4.1384; CRankcoeff07(iter)$(ord(iter) ge 10) = -3.8888;
CRankcoeff10('iter1') = -3.6235; CRankcoeff10('iter2') = -3.1003; CRankcoeff10('iter3') = -2.9841; CRankcoeff10('iter4') = -3.3235; CRankcoeff10('iter5') = 0; CRankcoeff10('iter6') = -2.3998; CRankcoeff10('iter7') = -2.3223; CRankcoeff10('iter8') = -3.1644; CRankcoeff10('iter9') = 0; CRankcoeff10(iter)$(ord(iter) ge 10) = 0;
CRankcoeff11('iter1') = -3.7724; CRankcoeff11('iter2') = -3.3449; CRankcoeff11('iter3') = -3.3449; CRankcoeff11('iter4') = -3.3449; CRankcoeff11('iter5') = -3.459; CRankcoeff11('iter6') = -3.3286; CRankcoeff11('iter7') = -4.3068; CRankcoeff11(iter)$(ord(iter) ge 8) = 0;

parameter RCRnkcoeff07(iter), RCRnkcoeff10(iter), RCRnkcoeff11(iter);
RCRnkcoeff07(iter) = 0; RCRnkcoeff07('iter2') = 1.9942; RCRnkcoeff10(iter) = 0; RCRnkcoeff10('iter5') = -2.8239; RCRnkcoeff11(iter) = 0;
      ...
      abort$(master_iter1.modelstat=4) "Relaxed Master is infeasible";
                  ...
                  loop(hubs$(not removedhubs(hubs) and LPsolz(hubs) eq 0),
                                 if(LPobj + LPRcstz(hubs) gt UB,
                                   ...
                                   findlimitnum = 0;
                                   loop(findlimit$(findlimitnum le card(hubs)),
                                            minhubnum = smin(hubs$(not foundhubs(hubs)), LPRcstz(hubs));
                                            foundflag = 0;
                                            loop(hubs$(not foundhubs(hubs) and minhubnum eq LPRcstz(hubs) and foundflag eq 0),
                                                      findlimitnum = findlimitnum + 1 ;
                                                      rankhubRDcost(hubs) = findlimitnum ;
                                                      foundhubs(hubs) = yes ;
                                                      foundflag = 1;
                                                 );
                                        );

                                   rankhubRDcstpct(hubs) = rankhubRDcost(hubs)/card(hubs);
                                   rankhubRDcstpct(hubs) = round(rankhubRDcstpct(hubs), 1);
                                   rankhubRDcstpct(hubs)$(rankhubRDcstpct(hubs) ge 0.5) = 0.5 ;

                                   zsollogistic(hubs)$(zsol(hubs) eq 1) = 1;
                                   zsollogistic(hubs)$(zsol(hubs) eq 0) = -1;
                                   if(CACapCoef eq 0.7,
                                         dependvalue(hubs) = constcoeff07(iter) + BDSolcoeff07(iter)*zsollogistic(hubs) + LPcoeff07(iter)*zrlxsol(hubs) + Lagcoeff07(iter)*z_feasol(hubs) + CRankcoeff07(iter)*rankhubcstpct(hubs) + RCRnkcoeff07(iter)*rankhubRDcstpct(hubs) ;
                                      );
                                   if(CACapCoef eq 1.0,
                                         dependvalue(hubs) = constcoeff10(iter) + BDSolcoeff10(iter)*zsollogistic(hubs) + LPcoeff10(iter)*zrlxsol(hubs) + Lagcoeff10(iter)*z_feasol(hubs) + CRankcoeff10(iter)*rankhubcstpct(hubs) + RCRnkcoeff10(iter)*rankhubRDcstpct(hubs) ;
                                      );
                                   if(CACapCoef eq 1.1,
                                         dependvalue(hubs) = constcoeff11(iter) + BDSolcoeff11(iter)*zsollogistic(hubs) + LPcoeff11(iter)*zrlxsol(hubs) + Lagcoeff11(iter)*z_feasol(hubs) + CRankcoeff11(iter)*rankhubcstpct(hubs) + RCRnkcoeff11(iter)*rankhubcstpct(hubs) ;
                                      );

                  probequalone(hubs) = exp(dependvalue(hubs))/(1 + exp(dependvalue(hubs))) ;
                  if(UB - warmupLB le avaerageHubCost and HubCostcoef gt 3,
                           getremovedsize = 1;
                           loop(testiter$(getremovedsize gt 0 and totaltime le MLstagetime),
                                    testdone = 0 ;
                                    Qhubs(hubs) = no;
                                    ...
                                    loop(hubs$Qhubs(hubs),
                                             getQhubsize = getQhubsize + 1 ;
                                         );
                                    if(getQhubsize le 0.3*card(hubs),
                                            removesizefromQ = floor(0.25*getQhubsize);
                                            else
                                             removesizefromQ = 0 ;
                                             loop(hubs$(Qhubs(hubs) and probequalone(hubs) le 0.3),
                                                        removesizefromQ = removesizefromQ + 1;
                                                 );
                                       );

                                    foundhubs(hubs) = no;
                                    findlimitnum = 0;
                                    loop(findlimit$(findlimitnum le removesizefromQ),
                                              minhubnum = smax(hubs$((not foundhubs(hubs)) and Qhubs(hubs)), probequalone(hubs));
                                              foundflag = 0;
                                              loop(hubs$((not foundhubs(hubs)) and Qhubs(hubs) and minhubnum eq probequalone(hubs) and foundflag eq 0),
                                                        findlimitnum = findlimitnum + 1 ;
                                                        Qhubs(hubs) = no ;
                                                        foundflag = 1;
                                                   );
                                    ...
                                    getremovedsize = 0;
                                    loop(testloop$(testdone eq 0 and availablehub eq 1 and totaltime le MLstagetime),
                                             ...
                                             if(MasterCost.l gt UB,
                                                    testdone = 1 ;
                                                    removedhubs(hubs)$Qhubs(hubs) = yes;
                                                    z.fx(hubs)$removedhubs(hubs) = 0;
                                                    loop(hubs$Qhubs(hubs),
                                                             getremovedsize = getremovedsize + 1 ;
                                                         );
                                                    else
                  ...
                  if(ETwarmupphase eq 0 and totaltime le MLstagetime,
                           findlimitnum = 0;
                           foundhubs(hubs) = no;
                           loop(findlimit$(findlimitnum le card(hubs)),
                                    minhubnum = smin(hubs$(not foundhubs(hubs)), probequalone(hubs));
                                    foundflag = 0;
                                    loop(hubs$(not foundhubs(hubs) and minhubnum eq probequalone(hubs) and foundflag eq 0),
                                              findlimitnum = findlimitnum + 1 ;
                                              rankhubprobability(hubs) = findlimitnum/card(hubs) ;
                                              foundhubs(hubs) = yes ;
                                              foundflag = 1;
                                         );
                                );
                           removedhubs2(hubs) = no;
                           removedhubs2(hubs)$(rankhubprobability(hubs) le probthreshold and rankhubprobability(hubs) le (card(hubs)-5)/card(hubs)) = yes;
                           loop(hubs$(removedhubs2(hubs) and remove2check eq 0),
                                    removedhubnum2 = removedhubnum2 + 1;
                                 );
                           remove2check = 1;
                           z.fx(hubs)$removedhubs2(hubs) = 0;
                           solve master minimizing MasterCost using mip;
                           totaltime = totaltime + master.etSolve;
                           mastersoltime = mastersoltime + master.etSolve;
                           modelsovstatus = master.modelstat ;
                           display removedhubs2;
                           z.lo(hubs)$removedhubs2(hubs) = 0;
                           z.up(hubs)$removedhubs2(hubs) = 1;
                           z.fx(hubs)$removedhubs(hubs) = 0;
...
file LagBD_IC_MC_MLBD2ProbRank06 /LagBD_IC_MC_MLBD2ProbRank06.dat/;
put LagBD_IC_MC_MLBD2ProbRank06;
LagBD_IC_MC_MLBD2ProbRank06.ap = 1;
...
put  %ID%, " ", removedhubnum, " ", removedhubnum2, " ", LagTime, " ", LagLB, " ", LagUB, " ", subprobtime, " ", mastersoltime, " ", testingtime, " ", uncaptime, " ", totaltime, " ", Bendcutnum, " ", totalopenhubs, " ", totalhubcost, " ", totalIassCost, " ", totalDassCost, " ", totaltransportcost, " ", LB, " ", UB  ///


display  removedhubnum, " ", removedhubnum2, " ", LagTime, " ", LagLB, " ", LagUB, " ", subprobtime, " ", mastersoltime, " ", testingtime, " ", uncaptime, " ", totaltime, " ", Bendcutnum, " ", totalopenhubs, " ", totalhubcost, " ", totalIassCost, " ", totalDassCost, " ", totaltransportcost, " ", LB, " ", UB ;
